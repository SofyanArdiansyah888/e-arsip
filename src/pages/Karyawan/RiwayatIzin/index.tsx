...
import { CreateIzinTelat } from "./CreateIzin";
import { EditIzinTelat } from "./EditIzin";
  ...
  return (
    <>
      <div className="flex flex-nowrap justify-between mt-10">
        <h2 className=" text-lg font-medium intro-y">List Izin Karyawan</h2>
      ...
      <div className="grid grid-cols-12 gap-6 mt-5">
        ...
        <DeleteModal
          ...
          title={`RiwayatIzin Karyawan ${selectedItem?.karyawan.nama_lengkap}`}
        />
        <EditIzinTelat
          isModal={editModal}
      ...
      <Table sm>
        <Table.Thead variant="dark">
          <Table.Tr className="text-center">
            ...
            <Table.Th>Tanggal Izin</Table.Th>
