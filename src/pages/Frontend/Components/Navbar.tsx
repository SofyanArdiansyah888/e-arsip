...
export default function Navbar() {
    ...
    return (<nav
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" className="flex w-[100px] lg:w-auto items-center">
                ...
                >
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <li>
                            <Link
                                to="/"
                                className={`block py-2 pl-3 pr-4 rounded md:bg-transparent  md:p-0 ${"/" === hash ? "text-green-700" : "text-slate-700"} `}
                                aria-current="page"
                            >
                                Beranda
                            </Link>
                        ...
                        <li>
                            <div className="group relative">
                                <button
                                    className={`menu-hover block py-2 pl-3 pr-4 rounded md:bg-transparent  md:p-0 ${"/" === hash ? "text-green-700" : "text-slate-700"} `}
                                >
                                    Profil
                                </button>
                                <div
                                ...
                                >
                                    <ul className="space-y-1" role="none">
                                        ...
                                        >
                                            Profil Pejabat
                                            <div
                                                className={`absolute min-w-[150px] left-[132px] top-0 z-10 bg-white border border-gray-100 rounded-lg shadow-md px-2 py-4 cursor-pointer ${isProfil ? "" : "hidden"}`}
                                            >
                                                <ul>
                                                    <li className="hover:bg-green-200  rounded-md">
                                                        <Link to={PATHNAME.PROFIL_GUBERNUR}>
                                                            <div className="py-2 px-1">Gubernur</div>
                                                        </Link>
                                                    </li>
                                                    <li className="hover:bg-green-200 rounded-md">
                                                        <Link to={PATHNAME.PROFIL_WAKIL_GUBERNUR}>
                                                            <div className="py-2 px-1">Wakil Gubernur</div>
                                                        </Link>
                                                    </li>
                                                    <li className="hover:bg-green-200 rounded-md">
                                                        <Link to={PATHNAME.PROFIL_PEJABAT}>
                                                            <div className="py-2 px-1">Sekda</div>
                                                        </Link>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <li>
                            <div className="group relative">
                                <button
                                    className={`block py-2 pl-3 pr-4 rounded md:bg-transparent  md:p-0 ${"/layanan" === hash ? "text-green-700" : "text-slate-700"} `}
                                >
                                    Layanan
                                </button>
                                <div
